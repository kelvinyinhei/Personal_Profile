...
#print(os.getcwd())
data_path = os.path.join( "./data", "project_1", "eod-quotemedia.csv")
#!ls $data_path
df = pd.read_csv(data_path, parse_dates=['date'], index_col=False)
...
def resample_prices(close_prices, freq='M'):
    ...
    ####################################################
    # Resample
    resampled_price = close_prices.resample(freq).last()
...
def shift_returns(returns, shift_n):
    ...
    ##########################
    # Shift stock price 
    shifted_price = returns.shift(shift_n)
...
def portfolio_returns(df_long, df_short, lookahead_returns, n_stocks):
    ...
    ###########################
    # Portfolio return 
    portfolio_return = lookahead_returns/3*(df_long - df_short)
...
def analyze_alpha(expected_portfolio_returns_by_date):
    ...
    # TODO: Implement Function
    #Convert to list 
    list_of_expected_portfolio_returns_by_date = expected_portfolio_returns_by_date.tolist()
    # Perform T-test
    T_Test_output = stats.ttest_1samp(list_of_expected_portfolio_returns_by_date, 0)
    t_value = T_Test_output[0]
    # Divide p-value by 2 as required in questions
    p_value = T_Test_output[1]/2
