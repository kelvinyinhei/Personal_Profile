...
def factor_betas(pca, factor_beta_indices, factor_beta_columns):
    ...
    # Transponse array becoz equity ticker becomes index
    factor_betas = pd.DataFrame(pca.components_.T, columns = factor_beta_columns)
    factor_betas = factor_betas.set_index(factor_beta_indices)
...
# **Answer:** 
# 
# From the Factor Rank Autocorrection graph, momentum factor has the most stable performance. Therefore, even Smoothing is used to remove signal noises, it has no major change on performance.
